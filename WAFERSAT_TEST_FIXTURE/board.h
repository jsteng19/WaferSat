...
/*
 * Setup for Wafersat Text Fixture board.
 */

/*
 * Board identifier.
 */
#define BOARD_WAFERSAT_TEST_FIXTURE
#define BOARD_NAME                  "Wafersat Text Fixture"
...
#define LINE_HEADER_PINB9           PAL_LINE(GPIOB, 9U)
 ...
 * GPIOA setup:
 *
 * PA0  - UART4_TX                  (alternate 7).
 * PA1  - UART4_RX                  (alternate 7).
 * PA2  - UART2_TX                  (alternate 7).
 * PA3  - UART2_RX                  (alternate 7).
 * PA4  - DCMI_HSYNC                (alternate 13).
 * PA5  - SPI1_SCK                  (input floating).
 * PA6  - DCMI_PXCLK                (alternate 13).
 * PA7  - SPI1_MOSI                 (input floating).
 * PA8  - RCC_MCO_1                 (input pullup).
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOA_UART4_TX) |   \
                                     ...
                                     PIN_OSPEED_VERYLOW(GPIOA_UART2_TX) |   \
                                     PIN_OSPEED_VERYLOW(GPIOA_UART2_RX) |   \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_UART4_TX, 7U) |      \
                                     PIN_AFIO_AF(GPIOA_UART4_RX, 7U) |      \
...
#define VAL_GPIOB_MODER             (PIN_MODE_OUTPUT(GPIOB_CAM_RESET) |     \
                                     ...
                                     PIN_MODE_INPUT(GPIOB_HEADER_PINB9) |   \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_CAM_RESET) |  \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOB_HEADER_PINB9) |\
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_VERYLOW(GPIOB_CAM_RESET) |  \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOB_HEADER_PINB9) |  \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_CAM_RESET) |    \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOB_HEADER_PINB9) | \
...
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_CAM_RESET) |        \
                                     ...
                                     PIN_ODR_HIGH(GPIOB_HEADER_PINB9) |     \
...
#define VAL_GPIOB_AFRH              (PIN_AFIO_AF(GPIOB_I2C1_SCL, 4U) |      \
                                     PIN_AFIO_AF(GPIOB_HEADER_PINB9, 0U) |  \
...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_FMC_SDNWE, 12U) |    \
                                     ...
                                     PIN_AFIO_AF(GPIOC_DCMI_D0, 13U) |      \
                                     PIN_AFIO_AF(GPIOC_DCMI_D1, 13U))
...
#define VAL_GPIOG_MODER             (PIN_MODE_ALTERNATE(GPIOG_FMC_A10) |    \
                                     ...
                                     PIN_MODE_ALTERNATE(GPIOG_DCMI_VSYNC) | \
...
#define VAL_GPIOG_AFRH              (PIN_AFIO_AF(GPIOG_FMC_SDCLK, 12U) |    \
                                     PIN_AFIO_AF(GPIOG_DCMI_VSYNC, 13U) |   \
